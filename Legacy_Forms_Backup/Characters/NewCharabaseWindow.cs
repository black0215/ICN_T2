    ...
    public partial class NewCharabaseWindow : Form
    {
        ...
        private void AddButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    modelPath = GameOpened.Files["model"].File.Directory;
                ...
                {
                    iconPath = GameOpened.Files["face_icon"].File.Directory;
                ...
                if (newModelTextBox.Text != null && newModelTextBox.Text != "")
                {
                    var newModelFolder = new VirtualDirectory(fileName);
                    modelPath.AddFolder(newModelFolder);
                    modelPath = newModelFolder;
