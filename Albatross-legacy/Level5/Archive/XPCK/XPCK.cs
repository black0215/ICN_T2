...
using Albatross.Level5.Compression.Zlib;
using Albatross.Level5.Compression.LZ10;

namespace Albatross.Level5.Archive.XPCK
{
    public class XPCK : IArchive
    {
        ...
        public void Save(string fileName, Action<int, int, string> progressCallback)
        {
            using (FileStream stream = new FileStream(fileName, FileMode.Create, FileAccess.Write))
            {
                ...
                foreach (var file in Directory.Files)
                {
                    ...
                    {
                        progressCallback((int)bytesWritten, (int)totalBytes, file.Key);
                    }
                }
